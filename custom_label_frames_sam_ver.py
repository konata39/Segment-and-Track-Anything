...
import custom_multiple_individuals_labeling_toolbox
...
def label_frames(
    ...
    #    custom_multiple_individuals_labeling_toolbox.show(config, config3d, sourceCam, jump_unlabeled)
    #else:
...
class Label_frames(wx.Panel):
    ...
    def __init__(self, parent, gui_size, cfg):
        ...
        self.select_frames = wx.Button(self, label="Select Frames")
        sizer.Add(self.select_frames, pos=(5, 0), flag=wx.LEFT, border=10)
